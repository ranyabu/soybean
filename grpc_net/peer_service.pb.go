...
// source: grpc_net/peer_service.proto
...
func init() { proto.RegisterFile("grpc_net/peer_service.proto", fileDescriptor_271c6162f2511c87) }
...
func (c *peerServiceClient) Handle(ctx context.Context, opts ...grpc.CallOption) (PeerService_HandleClient, error) {
	stream, err := c.cc.NewStream(ctx, &_PeerService_serviceDesc.Streams[0], "/grpc_net.PeerService/Handle", opts...)
	if err != nil {
		return nil, err
	}
...
var _PeerService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_net.PeerService",
	...
	Metadata: "grpc_net/peer_service.proto",
}
